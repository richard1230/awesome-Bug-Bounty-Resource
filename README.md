# awesome-Bug-Bounty-Resource

## Resource

* [Hacking on Bug Bounties for Four Years](https://blog.assetnote.io/2020/09/15/hacking-on-bug-bounties-for-four-years/)

* [Facebook-Bug-Bounty-Write-ups](https://github.com/richard1230/Facebook-Bug-Bounty-Write-ups)

* [ A Frida script to bypass SSL pinning in Instagram (iOS)](https://github.com/kov4l3nko/InstagramSSLPinningBypass-iOS)

* [Facebook public vulnerabilities](https://docs.google.com/spreadsheets/d/1ur_IIwED34P8X4_WXukXmJsVYSyGF0BLZmTlSZwzy1U/edit#gid=0)
